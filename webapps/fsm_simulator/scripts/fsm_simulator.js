...
$("#startStop").click(function() {
  if ($("#startStop").text() === "Start") {
    ...
    $("#inputString").parent().html('<div id="inputString" type="text" class="input-div input-block-level monospaceRegex" placeholder="Enter String"><br></div>');
    ...
    $("#inputString").parent().html('<input id="inputString" type="text" class="input-block-level monospaceRegex" placeholder="Enter String">');
...
// Change default input mode to FSM input by setting inputIsRegex to false.
var regex = null;
var automaton = null;
...
var nextStates = null;
var inputIsRegex = false; // <-- Changed from true to false
...
function onRegexOrAutomatonChange() {
  ...
  $("#inputPrevious").attr("disabled", true);
  $("#inputLast").attr("disabled", true);
  $("#inputString").parent().html('<input id="inputString" type="text" class="input-block-level monospaceRegex" placeholder="Enter String" disabled>');
